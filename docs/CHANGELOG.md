# v1.9 · revizija razlage dogodkov · 30. julij 2026

- podatkovna datoteka `apps/analitika/data-js/events.js` ostaja vsebinsko nespremenjena in vsebuje 3.547 dnevnih zapisov za obdobje 1. 11. 2023–10. 8. 2026;
- revidirana je razlaga komponente Dogodki v indeksu Utrip Tržiča: štejejo se aktivni koledarski dnevi dogodkov, ne različne prireditve ali obiskovalci;
- dodano je opozorilo, da večdnevni dogodki prispevajo po en zapis za vsak dan in da so robni delni meseci manj primerljivi;
- dnevni odgovor »Kaj se je zgodilo dne …?« jasneje ločuje evidentiran dogodek od dokazanega vpliva na promet ali parkiranje;
- razširjeni koledar izboljša vsebinski kontekst, ne zvišuje pa samodejno ocene statistične zanesljivosti prometno-parkirnega modela;
- formule, uteži, podatkovne datoteke, postavitev in druge aplikacije niso spremenjene.
