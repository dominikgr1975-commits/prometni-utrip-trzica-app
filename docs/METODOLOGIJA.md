...
Komponenta **Dogodki** temelji na dnevnih zapisih koledarja. Večdnevni dogodki so razširjeni na vsak aktiven koledarski dan, zato mesečna vrednost predstavlja število aktivnih dni dogodkov in ne števila različnih prireditev. Koledar nima podatka o številu obiskovalcev, velikosti prireditve ali dejanskem prometnem učinku. Robni delni meseci izvoza so lahko manj primerljivi s polnimi meseci. Razširjeni koledar izboljša vsebinski kontekst in dnevne razlage, vendar sam po sebi ne zvišuje statistične zanesljivosti prometno-parkirnega modela.
